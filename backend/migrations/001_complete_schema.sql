-- =====================================================
-- ATS SCORE ENGINE - COMPLETE DATABASE SCHEMA
-- =====================================================
-- Description: Complete database setup including authentication, RBAC, 
--              jobs, resumes, and ATS scoring
-- Version: 1.0
-- Date: 2026-02-07
-- =====================================================
...
COMMENT ON TABLE jobs IS 'Job postings created by HR users';
...
-- 2. Update users_profiles with admin user ID
